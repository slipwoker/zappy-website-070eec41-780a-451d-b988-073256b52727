  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      if (field.hasAttribute('required') || dataset.required === 'true') {
        ...
        // Optional empty field — skip further validation
        clearError(field);
        return true;
      }
    ...
    const getValidatableFields = function () {
    ...
    contactForm.addEventListener('blur', function (e) {
      ...
      if (!field || field.closest('.contact-form') !== contactForm) return;
      validateField(field);
    }, true);
  ...
  if (animationElements.length > 0) {
    ...
    if ('IntersectionObserver' in window) {
      ...
      animationElements.forEach(function (el) {
        // Ensure element starts hidden if not already styled via CSS
        if (!el.classList.contains(ANIMATION_CLASS)) {
          el.setAttribute('data-scroll-pending', 'true');
        }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אוזומאקי סושי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '070eec41-780a-451d-b988-073256b52727',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '070eec41-780a-451d-b988-073256b52727';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '070eec41-780a-451d-b988-073256b52727';
